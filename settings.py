...
SESSION_CONFIG_DEFAULTS = dict(
    ...
    market_opening='25 Jun 2024 18:50:00',
    market_closing='25 Jun 2024 19:40:00',
    currency_unit='&euro;',
    buyer_share=2,
    # time_unit='seconds',
    price_floor=0.00,
    ...
    lower_bound_minimum_mc=30,
    upper_bound_minimum_mc=44,
    lower_bound_maximum_mu=66,
    upper_bound_maximum_mu=80,
    mc_step_size=15,
    mu_step_size=15,
    production_time=120,
